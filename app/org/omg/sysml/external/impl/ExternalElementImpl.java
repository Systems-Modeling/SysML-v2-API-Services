...
import org.omg.sysml.external.ExternalElement;
...
@Entity(name = "ExternalElementImpl")
@SecondaryTable(name = "ExternalElement")
@org.hibernate.annotations.Table(appliesTo = "ExternalElement", fetch = FetchMode.SELECT, optional = false)
...
public class ExternalElementImpl extends SysMLTypeImpl implements ExternalElement {
    ...
    @JsonGetter
    @javax.persistence.Column(name = "resourceIdentifier", table = "ExternalElement")
    ...
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    // @javax.persistence.Transient
    @javax.persistence.Column(name = "effectiveName", table = "ExternalElement")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "ExternalElement")
    ...
    @JsonGetter
    @javax.persistence.Column(name = "identifier", table = "ExternalElement")
    ...
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    // @javax.persistence.Transient
    @javax.persistence.Column(name = "name", table = "ExternalElement")
    ...
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    // @javax.persistence.Transient
    @javax.persistence.Column(name = "qualifiedName", table = "ExternalElement")
