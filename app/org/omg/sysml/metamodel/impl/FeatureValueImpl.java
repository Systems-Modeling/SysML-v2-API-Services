...
public class FeatureValueImpl extends SysMLTypeImpl implements FeatureValue {
    ...
    @CollectionTable(name = "FeatureValue_aliasId",
    ...
    @JoinTable(name = "FeatureValue_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    // @javax.persistence.Transient
    @javax.persistence.Column(name = "effectiveMemberName", table = "FeatureValue")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "FeatureValue")
    ...
    @JoinColumn(name = "memberElementId", table = "FeatureValue")
    ...
    @JoinColumn(name = "membershipOwningNamespaceId", table = "FeatureValue")
    ...
    @JoinColumn(name = "ownedMemberElementId", table = "FeatureValue")
    ...
    @JoinTable(name = "FeatureValue_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
