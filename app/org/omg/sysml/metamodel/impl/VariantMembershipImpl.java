...
public class VariantMembershipImpl extends SysMLTypeImpl implements VariantMembership {
    ...
    @CollectionTable(name = "VariantMembership_aliasId",
            joinColumns = @JoinColumn(name = "VariantMembershipId"))
    ...
    @JoinTable(name = "VariantMembership_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    // @javax.persistence.Transient
    @javax.persistence.Column(name = "effectiveMemberName", table = "VariantMembership")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "VariantMembership")
    ...
    @JoinColumn(name = "membershipOwningNamespaceId", table = "VariantMembership")
    ...
    @JoinTable(name = "VariantMembership_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
