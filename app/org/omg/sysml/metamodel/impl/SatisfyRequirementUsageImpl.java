...
public class SatisfyRequirementUsageImpl extends SysMLTypeImpl implements SatisfyRequirementUsage {
    ...
    @JoinColumn(name = "assertedConstraintId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "constraintDefinitionId", table = "SatisfyRequirementUsage")
    ...
    @JoinTable(name = "SatisfyRequirementUsage_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "endOwningTypeId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "functionId", table = "SatisfyRequirementUsage")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "SatisfyRequirementUsage")
    ...
    @JsonGetter
    @javax.persistence.Column(name = "identifier", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "individualDefinitionId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "multiplicityId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "ownedConjugatorId", table = "SatisfyRequirementUsage")
    ...
    @JoinTable(name = "SatisfyRequirementUsage_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "ownerId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "owningDefinitionId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "owningFeatureMembershipId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "owningMembershipId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "owningNamespaceId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "owningRelationshipId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "owningTypeId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "owningUsageId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "portioningFeatureId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "predicateId", table = "SatisfyRequirementUsage")
    ...
    @JsonSerialize(using = DataSerializer.class)
    // @javax.persistence.Transient
    @Any(metaDef = "RequirementDefinitionMetaDef", metaColumn = @javax.persistence.Column(name = "requirementDefinitionType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "requirementDefinitionId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "resultId", table = "SatisfyRequirementUsage")
    ...
    @JsonSerialize(using = DataSerializer.class)
    // @javax.persistence.Transient
    @Any(metaDef = "RequirementUsageMetaDef", metaColumn = @javax.persistence.Column(name = "satisfiedRequirementType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "satisfiedRequirementId", table = "SatisfyRequirementUsage")
    ...
    @JsonSerialize(using = DataSerializer.class)
    // @javax.persistence.Transient
    @Any(metaDef = "FeatureMetaDef", metaColumn = @javax.persistence.Column(name = "satisfyingFeatureType"), fetch = FetchType.LAZY)
    @JoinColumn(name = "satisfyingFeatureId", table = "SatisfyRequirementUsage")
    ...
    @JoinColumn(name = "subjectParameterId", table = "SatisfyRequirementUsage")
