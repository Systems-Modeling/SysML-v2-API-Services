...
public class LiteralExpressionImpl extends SysMLTypeImpl implements LiteralExpression {
    ...
    @CollectionTable(name = "LiteralExpression_aliasId",
    ...
    @JoinTable(name = "LiteralExpression_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinTable(name = "LiteralExpression_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "endOwningTypeId", table = "LiteralExpression")
    ...
    @JoinColumn(name = "functionId", table = "LiteralExpression")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "LiteralExpression")
    ...
    @JoinTable(name = "LiteralExpression_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "ownerId", table = "LiteralExpression")
    ...
    @JoinColumn(name = "owningFeatureMembershipId", table = "LiteralExpression")
    ...
    @JoinColumn(name = "owningMembershipId", table = "LiteralExpression")
    ...
    @JoinColumn(name = "owningNamespaceId", table = "LiteralExpression")
    ...
    @JoinColumn(name = "owningTypeId", table = "LiteralExpression")
    ...
    @JoinColumn(name = "resultId", table = "LiteralExpression")
