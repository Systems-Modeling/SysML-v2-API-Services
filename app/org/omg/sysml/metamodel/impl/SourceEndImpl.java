...
public class SourceEndImpl extends SysMLTypeImpl implements SourceEnd {
    ...
    @CollectionTable(name = "SourceEnd_aliasId",
    ...
    @JoinTable(name = "SourceEnd_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinTable(name = "SourceEnd_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "SourceEnd")
    ...
    @JoinColumn(name = "ownedConjugatorId", table = "SourceEnd")
    ...
    @JoinTable(name = "SourceEnd_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
