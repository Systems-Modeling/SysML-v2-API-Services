...
public class InterfaceUsageImpl extends SysMLTypeImpl implements InterfaceUsage {
    ...
    @CollectionTable(name = "InterfaceUsage_aliasId",
            joinColumns = @JoinColumn(name = "InterfaceUsageId"))
    ...
    @JoinTable(name = "InterfaceUsage_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "endOwningTypeId", table = "InterfaceUsage")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "individualDefinitionId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "multiplicityId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "ownedConjugatorId", table = "InterfaceUsage")
    ...
    @JoinTable(name = "InterfaceUsage_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "ownerId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "owningDefinitionId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "owningFeatureMembershipId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "owningMembershipId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "owningNamespaceId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "owningRelatedElementId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "owningRelationshipId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "owningTypeId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "owningUsageId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "portioningFeatureId", table = "InterfaceUsage")
    ...
    @JoinColumn(name = "sourceFeatureId", table = "InterfaceUsage")
