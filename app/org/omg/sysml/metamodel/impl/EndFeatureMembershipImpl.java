...
public class EndFeatureMembershipImpl extends SysMLTypeImpl implements EndFeatureMembership {
    ...
    @CollectionTable(name = "EndFeatureMembership_aliasId",
    ...
    @JoinTable(name = "EndFeatureMembership_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    // @javax.persistence.Transient
    @javax.persistence.Column(name = "effectiveMemberName", table = "EndFeatureMembership")
    ...
    @JoinColumn(name = "featureOfTypeId", table = "EndFeatureMembership")
    ...
    @JoinColumn(name = "featuringTypeId", table = "EndFeatureMembership")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "EndFeatureMembership")
    ...
    @JoinColumn(name = "memberElementId", table = "EndFeatureMembership")
    ...
    @JoinTable(name = "EndFeatureMembership_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "owningFeatureOfTypeId", table = "EndFeatureMembership")
