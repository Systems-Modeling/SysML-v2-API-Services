...
public class RequirementDefinitionImpl extends SysMLTypeImpl implements RequirementDefinition {
    ...
    @CollectionTable(name = "RequirementDefinition_aliasId",
            joinColumns = @JoinColumn(name = "RequirementDefinitionId"))
    ...
    @JoinTable(name = "RequirementDefinition_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinTable(name = "RequirementDefinition_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "RequirementDefinition")
    ...
    @JsonGetter
    @javax.persistence.Column(name = "identifier", table = "RequirementDefinition")
    ...
    @JoinColumn(name = "multiplicityId", table = "RequirementDefinition")
    ...
    @JoinColumn(name = "ownedConjugatorId", table = "RequirementDefinition")
    ...
    @JoinTable(name = "RequirementDefinition_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "ownerId", table = "RequirementDefinition")
    ...
    @JoinColumn(name = "owningMembershipId", table = "RequirementDefinition")
    ...
    @JoinColumn(name = "owningNamespaceId", table = "RequirementDefinition")
    ...
    @JoinColumn(name = "owningRelationshipId", table = "RequirementDefinition")
    ...
    @JoinColumn(name = "resultId", table = "RequirementDefinition")
    ...
    @JoinColumn(name = "subjectParameterId", table = "RequirementDefinition")
