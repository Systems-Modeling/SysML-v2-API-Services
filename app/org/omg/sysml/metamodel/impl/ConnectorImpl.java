...
public class ConnectorImpl extends SysMLTypeImpl implements Connector {
    ...
    @CollectionTable(name = "Connector_aliasId",
    ...
    @JoinTable(name = "Connector_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinTable(name = "Connector_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "endOwningTypeId", table = "Connector")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "Connector")
    ...
    @JoinColumn(name = "multiplicityId", table = "Connector")
    ...
    @JoinColumn(name = "ownedConjugatorId", table = "Connector")
    ...
    @JoinTable(name = "Connector_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "ownerId", table = "Connector")
    ...
    @JoinColumn(name = "owningFeatureMembershipId", table = "Connector")
    ...
    @JoinColumn(name = "owningMembershipId", table = "Connector")
    ...
    @JoinColumn(name = "owningRelatedElementId", table = "Connector")
    ...
    @JoinColumn(name = "owningRelationshipId", table = "Connector")
    ...
    @JoinColumn(name = "owningTypeId", table = "Connector")
    ...
    @JoinColumn(name = "sourceFeatureId", table = "Connector")
