...
@AnyMetaDefs(value = {
        @AnyMetaDef(name = "MofObjectMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        ...
                        @MetaValue(value = "AddressedConcernMembership", targetEntity = AddressedConcernMembershipImpl.class),
                        ...
                        @MetaValue(value = "StakeholderDefinition", targetEntity = StakeholderDefinitionImpl.class),
                        @MetaValue(value = "StakeholderUsage", targetEntity = StakeholderUsageImpl.class),
        ...
        @AnyMetaDef(name = "AddressedConcernMembershipMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "AddressedConcernMembership", targetEntity = AddressedConcernMembershipImpl.class),
                }),
        ...
        @AnyMetaDef(name = "StakeholderDefinitionMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "StakeholderDefinition", targetEntity = StakeholderDefinitionImpl.class),
                }),
        @AnyMetaDef(name = "StakeholderUsageMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "StakeholderUsage", targetEntity = StakeholderUsageImpl.class),
                }),
