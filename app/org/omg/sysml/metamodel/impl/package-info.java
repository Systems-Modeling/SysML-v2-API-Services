@AnyMetaDefs(value = {
        ...
        @AnyMetaDef(name = "FeatureMembershipMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        ...
                        @MetaValue(value = "ConjugatedEndPortMembership", targetEntity = ConjugatedEndPortMembershipImpl.class),
                        @MetaValue(value = "EndPortMembership", targetEntity = EndPortMembershipImpl.class),
        ...
        @AnyMetaDef(name = "ConjugatedEndPortMembershipMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "ConjugatedEndPortMembership", targetEntity = ConjugatedEndPortMembershipImpl.class),
                }),
        @AnyMetaDef(name = "EndPortMembershipMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "EndPortMembership", targetEntity = EndPortMembershipImpl.class),
                }),
