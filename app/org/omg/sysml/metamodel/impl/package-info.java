@AnyMetaDefs(value = {
        ...
        @AnyMetaDef(name = "FeatureMembershipMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        ...
                        @MetaValue(value = "PortMembership", targetEntity = PortMembershipImpl.class),
                        @MetaValue(value = "ParameterMembership", targetEntity = ParameterMembershipImpl.class),
                        @MetaValue(value = "ConjugatedPortMembership", targetEntity = ConjugatedPortMembershipImpl.class),
        ...
        @AnyMetaDef(name = "FeatureMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        ...
                        @MetaValue(value = "ConditionalSuccession", targetEntity = ConditionalSuccessionImpl.class),
        ...
        @AnyMetaDef(name = "PortMembershipMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "PortMembership", targetEntity = PortMembershipImpl.class),
                        @MetaValue(value = "ConjugatedPortMembership", targetEntity = ConjugatedPortMembershipImpl.class),
                }),
        ...
        @AnyMetaDef(name = "ConditionalSuccessionMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "ConditionalSuccession", targetEntity = ConditionalSuccessionImpl.class),
                }),
        ...
        @AnyMetaDef(name = "ConjugatedPortMembershipMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "ConjugatedPortMembership", targetEntity = ConjugatedPortMembershipImpl.class),
                }),
