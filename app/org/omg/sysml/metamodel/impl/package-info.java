...
@AnyMetaDefs(value = {
        ...
        @AnyMetaDef(name = "PathSelectExpressionMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "PathSelectExpression", targetEntity = PathSelectExpressionImpl.class),
                }),
        @AnyMetaDef(name = "PathStepExpressionMetaDef", metaType = "string", idType = "java.util.UUID",
                metaValues = {
                        @MetaValue(value = "PathStepExpression", targetEntity = PathStepExpressionImpl.class),
                }),
