...
public class CaseDefinitionImpl extends SysMLTypeImpl implements CaseDefinition {
    ...
    @CollectionTable(name = "CaseDefinition_aliasId",
            joinColumns = @JoinColumn(name = "CaseDefinitionId"))
    ...
    @JoinTable(name = "CaseDefinition_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinTable(name = "CaseDefinition_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "CaseDefinition")
    ...
    @JoinColumn(name = "lifeClassId", table = "CaseDefinition")
    ...
    @JoinTable(name = "CaseDefinition_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
