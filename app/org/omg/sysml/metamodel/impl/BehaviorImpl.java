...
public class BehaviorImpl extends SysMLTypeImpl implements Behavior {
    ...
    @CollectionTable(name = "Behavior_aliasId",
    ...
    @JoinTable(name = "Behavior_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "Behavior")
    ...
    @JoinColumn(name = "multiplicityId", table = "Behavior")
    ...
    @JoinColumn(name = "ownedConjugatorId", table = "Behavior")
    ...
    @JoinColumn(name = "ownerId", table = "Behavior")
    ...
    @JoinColumn(name = "owningMembershipId", table = "Behavior")
