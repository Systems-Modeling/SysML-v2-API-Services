...
public class ParameterMembershipImpl extends MofObjectImpl implements ParameterMembership {
    ...
    private org.omg.sysml.metamodel.Package membershipOwningPackage;

    @JsonProperty(required = true)
    @JsonGetter
    @JsonSerialize(using = MofObjectSerializer.class)
    @javax.persistence.Transient
    public org.omg.sysml.metamodel.Package getMembershipOwningPackage() {
    ...
    public void setMembershipOwningPackage(org.omg.sysml.metamodel.Package membershipOwningPackage) {
