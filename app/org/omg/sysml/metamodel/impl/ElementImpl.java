...
public class ElementImpl extends SysMLTypeImpl implements Element {
    ...
    @CollectionTable(name = "Element_aliasId",
    ...
    @JoinTable(name = "Element_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "Element")
    ...
    @JoinTable(name = "Element_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "ownerId", table = "Element")
    ...
    @JoinColumn(name = "owningMembershipId", table = "Element")
