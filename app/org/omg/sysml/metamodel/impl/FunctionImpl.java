...
public class FunctionImpl extends SysMLTypeImpl implements Function {
    ...
    @CollectionTable(name = "Function_aliasId",
    ...
    @JoinTable(name = "Function_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinTable(name = "Function_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "Function")
    ...
    @JoinColumn(name = "multiplicityId", table = "Function")
    ...
    @JoinColumn(name = "ownedConjugatorId", table = "Function")
    ...
    @JoinTable(name = "Function_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
