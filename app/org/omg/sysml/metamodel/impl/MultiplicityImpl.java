...
public class MultiplicityImpl extends SysMLTypeImpl implements Multiplicity {
    ...
    @CollectionTable(name = "Multiplicity_aliasId",
    ...
    @JoinTable(name = "Multiplicity_disjointType",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinTable(name = "Multiplicity_documentationComment",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "endOwningTypeId", table = "Multiplicity")
    ...
    @Lob
    @org.hibernate.annotations.Type(type = "org.hibernate.type.TextType")
    @javax.persistence.Column(name = "humanId", table = "Multiplicity")
    ...
    @JoinColumn(name = "multiplicityId", table = "Multiplicity")
    ...
    @JoinColumn(name = "ownedConjugatorId", table = "Multiplicity")
    ...
    @JoinTable(name = "Multiplicity_ownedTextualRepresentation",
            joinColumns = @JoinColumn(name = "classId"),
            inverseJoinColumns = @JoinColumn(name = "attributeId"))
    ...
    @JoinColumn(name = "owningFeatureMembershipId", table = "Multiplicity")
    ...
    @JoinColumn(name = "owningTypeId", table = "Multiplicity")
