...
public final class ElementController extends JsonLdController<Element, SysMLTypeJsonLdAdorner.Parameters> {
    ...
    public Result getElementByProjectIdCommitIdElementId(UUID projectId, UUID commitId, UUID elementId, Request request) {
        ...
        return buildResult(element.orElse(null), request, new SysMLTypeJsonLdAdorner.Parameters(projectId, commitId));
    }
    ...
    private Result buildPaginatedResult(List<Element> elements, UUID projectId, UUID commitId, Request request, PageRequest pageRequest) {
        return paginateResult(
                buildResult(elements, List.class, metamodelProvider.getImplementationClass(Element.class), request, new SysMLTypeJsonLdAdorner.Parameters(projectId, commitId)),
                elements.size(),
