...
public abstract class AttributeDefinitionImpl_ extends org.omg.sysml.lifecycle.impl.DataImpl_ {

	public static volatile ListAttribute<AttributeDefinitionImpl, Usage> directedUsage;
	public static volatile ListAttribute<AttributeDefinitionImpl, PortUsage> ownedPort;
	public static volatile SingularAttribute<AttributeDefinitionImpl, String> declaredShortName;
	public static volatile SingularAttribute<AttributeDefinitionImpl, Boolean> isConjugated;
	public static volatile ListAttribute<AttributeDefinitionImpl, EnumerationUsage> ownedEnumeration;
	public static volatile ListAttribute<AttributeDefinitionImpl, VerificationCaseUsage> ownedVerificationCase;
	public static volatile ListAttribute<AttributeDefinitionImpl, Usage> usage;
	public static volatile ListAttribute<AttributeDefinitionImpl, ViewpointUsage> ownedViewpoint;
	public static volatile ListAttribute<AttributeDefinitionImpl, AnalysisCaseUsage> ownedAnalysisCase;
	public static volatile ListAttribute<AttributeDefinitionImpl, RenderingUsage> ownedRendering;
	public static volatile ListAttribute<AttributeDefinitionImpl, ConstraintUsage> ownedConstraint;
	public static volatile ListAttribute<AttributeDefinitionImpl, Feature> output;
	public static volatile ListAttribute<AttributeDefinitionImpl, MetadataUsage> ownedMetadata;
	public static volatile CollectionAttribute<AttributeDefinitionImpl, Usage> variant;
	public static volatile ListAttribute<AttributeDefinitionImpl, ItemUsage> ownedItem;
	public static volatile SingularAttribute<AttributeDefinitionImpl, Boolean> isSufficient;
	public static volatile ListAttribute<AttributeDefinitionImpl, Differencing> ownedDifferencing;
	public static volatile SingularAttribute<AttributeDefinitionImpl, UUID> elementId;
	public static volatile ListAttribute<AttributeDefinitionImpl, TextualRepresentation> textualRepresentation;
	public static volatile SingularAttribute<AttributeDefinitionImpl, Boolean> isLibraryElement;
	public static volatile ListAttribute<AttributeDefinitionImpl, Annotation> ownedAnnotation;
	public static volatile ListAttribute<AttributeDefinitionImpl, ViewUsage> ownedView;
	...
	public static volatile ListAttribute<AttributeDefinitionImpl, Type> intersectingType;
	public static volatile ListAttribute<AttributeDefinitionImpl, Feature> endFeature;
	public static volatile ListAttribute<AttributeDefinitionImpl, Feature> directedFeature;
	public static volatile ListAttribute<AttributeDefinitionImpl, AllocationUsage> ownedAllocation;
	public static volatile ListAttribute<AttributeDefinitionImpl, InterfaceUsage> ownedInterface;
	public static volatile ListAttribute<AttributeDefinitionImpl, Feature> input;
	public static volatile CollectionAttribute<AttributeDefinitionImpl, FlowConnectionUsage> ownedFlow;
	public static volatile ListAttribute<AttributeDefinitionImpl, ActionUsage> ownedAction;
	public static volatile ListAttribute<AttributeDefinitionImpl, CaseUsage> ownedCase;
	public static volatile ListAttribute<AttributeDefinitionImpl, CalculationUsage> ownedCalculation;
	public static volatile ListAttribute<AttributeDefinitionImpl, OccurrenceUsage> ownedOccurrence;
	public static volatile SingularAttribute<AttributeDefinitionImpl, String> name;
	public static volatile ListAttribute<AttributeDefinitionImpl, ReferenceUsage> ownedReference;
	public static volatile ListAttribute<AttributeDefinitionImpl, Usage> ownedUsage;
	public static volatile SingularAttribute<AttributeDefinitionImpl, String> shortName;
	...
	public static volatile ListAttribute<AttributeDefinitionImpl, UseCaseUsage> ownedUseCase;
	public static volatile CollectionAttribute<AttributeDefinitionImpl, Disjoining> ownedDisjoining;
	public static volatile ListAttribute<AttributeDefinitionImpl, StateUsage> ownedState;
	public static volatile ListAttribute<AttributeDefinitionImpl, Membership> membership;
	public static volatile SingularAttribute<AttributeDefinitionImpl, Boolean> isImpliedIncluded;
	...
	public static volatile SingularAttribute<AttributeDefinitionImpl, String> declaredName;
	public static volatile ListAttribute<AttributeDefinitionImpl, FeatureMembership> ownedFeatureMembership;
	public static volatile CollectionAttribute<AttributeDefinitionImpl, Subclassification> ownedSubclassification;
	...
	public static volatile ListAttribute<AttributeDefinitionImpl, String> aliasIds;
	public static volatile ListAttribute<AttributeDefinitionImpl, Relationship> ownedRelationship;
	public static volatile ListAttribute<AttributeDefinitionImpl, ConnectorAsUsage> ownedConnection;
	...
	public static volatile ListAttribute<AttributeDefinitionImpl, RequirementUsage> ownedRequirement;
	public static volatile SingularAttribute<AttributeDefinitionImpl, Boolean> isAbstract;
	public static volatile ListAttribute<AttributeDefinitionImpl, Type> differencingType;
	public static volatile CollectionAttribute<AttributeDefinitionImpl, VariantMembership> variantMembership;
	public static volatile ListAttribute<AttributeDefinitionImpl, Unioning> ownedUnioning;
	public static volatile ListAttribute<AttributeDefinitionImpl, Type> unioningType;
	public static volatile ListAttribute<AttributeDefinitionImpl, Specialization> ownedSpecialization;
	public static volatile CollectionAttribute<AttributeDefinitionImpl, ConcernUsage> ownedConcern;
	public static volatile ListAttribute<AttributeDefinitionImpl, AttributeUsage> ownedAttribute;
	public static volatile ListAttribute<AttributeDefinitionImpl, Intersecting> ownedIntersecting;
	public static volatile ListAttribute<AttributeDefinitionImpl, PartUsage> ownedPart;
